...
function CartMenuItems(props){
    ...
    const addBtn = (
        ...
        <button className="btn btn-white" style={{width:"90px"}}
    ...
    const increaseBtn = (
        <button className="btn btn-primary" style={{ height:"35px", marginLeft: "14%" }}
        onClick={handleIncrement}>
            <span>+</span>
        </button>
    );
    ...
    const decreaseBtn = (
        <button className="btn btn-primary" style={{ height:"35px", marginRight: "14%" }}
    ...
    return (
        <div className="card bg-white " style={{ width: "18rem" }}>
            ...
            {quantity===0 ? (
                ...
                <div>
                <div className="btn btn-white" style={{display:"flex" , width:"90px"}}>
                    {decreaseBtn}
                   {qtyIndicator}
                   {increaseBtn} 
                </div>
